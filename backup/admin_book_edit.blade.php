...
<div class="container main-content">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Edit "[[ $book->title ]]"</h1>
        </div>
            ...
            <fieldset>
                ...
                <hr>
                 ...
                 <div class="form-group">
                    @if ($book->coverExists() )
                    <div class="pull-right col-md-4 ">
                        <button type="button" data-id="[[$book->book_id ]]" data-type="cover" class="delete_file btn-sm btn btn-danger" title="Remove File" data-toggle="tooltip"><i class="fa fa-trash-o"></i>
                        </button>
                        <a href="[[ URL::to('download/sample', array('id' => $book->book_id, 'type' => 4)) ]]" class="btn-sm btn btn-primary" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                    </div>
                    @endif
    ...
    $(document).ready(function () {
        $('#book').bootstrapValidator({
            ...
            .on('success.form.bv', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "/admin/books/postEdit",
                    ...
                    if(data.valid==true)
                    {
                        ...
                        $.each(BootstrapDialog.dialogs, function(id, dialog){
                         ...
                         BootstrapDialog.show({
                            title: '<i class="fa fa-check-circle"></i> Book Update Successful',
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    cssClass: 'btn-primary',
                                    action: function() {
                                        window.location.href = "[[URL::to('bookpage', $book->book_id) ]]";
                                    }
                                },
                                  {
                                    ...
                                    cssClass: 'btn-primary',
                                    action: function() {
                                        window.location.href = "[[URL::to('user/downloadBook', $book->book_id) ]]";
                                    }
                                },
                                 {
                                    ...
                                    cssClass: 'btn-primary',
                                    action: function() {
                                        window.location.href = "[[URL::to('admin/addAuthor', $book->book_id) ]]";
                                    }
                                },
                                {
