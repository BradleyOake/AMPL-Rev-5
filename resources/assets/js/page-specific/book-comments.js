    /*
     *  Sends the book post to be liked by the user
     */
    $(".like_book_comment").click(function () {
        console.log('test');
    }); < /script> < script >
        /*
         *  Sends the book post to be disliked by the user
         */
    ...
    $(document).ready(function () {
        ...
        .on('success.form.bv', function (e) {
            ...
            $.ajax({
                type: "post",
                url: public_path + "bookComment/submit",
    ...
    $(document).ready(function () {
        ...
        .on('success.form.bv', function (e) {
            ...
            $.ajax({
                type: "post",
                url: public_path + "bookComment/update",
                dataType: 'json', // expected returned data format.
                data: {
                    editcomment_text: editcomment_text
                },
                success: function (data) {
                    if (data.valid == true) {
                        location.reload();
                ...
                beforeSend: function () {
                    document.getElementById("editcomment_form").style.display = "none";
                    $("#editform_message").html("<br><br><br><h3>Submitting your comment...</h3><br><i class=\"fa fa-5x  fa-spinner fa-spin\"></i><br>")
                }
            });
            return false;
        });
