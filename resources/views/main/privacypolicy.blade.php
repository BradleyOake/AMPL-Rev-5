...
@section('metatags')
    <meta name="keywords" content="Welcome, E-Readers, E-Books, Aspiring Authors, Canadian, Publisher, Publish your work, Reader, Read, PDF, MP3, Text, Entertain, Novel, AMPL, Electronic books, Buy e-books, Buy books, Cheap books, Cheap e-books, Writers, Write, Make money writing" />
...
<div class="container main-content">
    ...
    <div class="row">
        <div class="col-lg-offset-1 col-lg-10">
            <br>
            This Privacy Policy governs the manner in which AMPL Publishing collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="[[ URL::to('') ]]">AMPL Books</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by AMPL Publishing.
            <br>
            <br>
            <br>
            ...
            <br>
            <br>We may collect personal identification information from Users in a variety of ways, including, but not limited to, when Users visit our site, register on the site, place an order, fill out a form, and in connection with other activities, services, features or resources we make available on our Site. Users may be asked for, as appropriate, name, email address. Users may, however, visit our Site anonymously. We will collect personal identification information from Users only if they voluntarily submit such information to us. Users can always refuse to supply personally identification information, except that it may prevent them from engaging in certain Site related activities.
            <br>
            <br>
            <br>
            ...
            <br>
            <br>AMPL Publishing may collect and use Users personal information for the following purposes:
            <br>
            <ul>
            ...
            <br>
            <br>AMPL Publishing has the discretion to update this privacy policy at any time. When we do, we will send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.
            <br>
            <br>
            <br>
            ...
            <br>
            <br>By using this Site, you signify your acceptance of this policy and terms of service. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.
            <br>
            <br>
            <br>
            ...
            <b>Contacting us</b>
            <br>
            <br>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please <a href="[[ URL::to('contact') ]]">contact us at AMPL Publishing</a>.
            <br>
            <br>This document was last updated on April 7, 2016
            <br>
            <br>
            <br>
        </div>
